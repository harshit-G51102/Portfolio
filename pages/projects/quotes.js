              ...
              <li>
                ...
                <section>
                    ...
                    <div className=" w-full border-2 border-sky-500 rounded-md shadow-lg shadow-indigo-500/50 dark:text-white p-4 grid-cols-1 md:grid grid-cols-3 gap-4 mb-8">
                        ...
                        <div><Image src={quotes1} className="rounded-xl shadow-lg md:-mt-12 md:ml-12" /></div>
                    </div>
                    <div className=" w-full border-2 border-sky-500 rounded-md shadow-lg shadow-indigo-500/50 dark:text-white p-4 grid-cols-1 md:grid grid-cols-3 gap-4 mb-8">
                        <div><Image src={quotes2} className="rounded-xl shadow-lg md:-mb-8 md:-ml-12" /></div>
                        <div className="col-span-2 text-center flex items-center ">
                            <div>
                    ...
                    <div className=" w-full border-2 border-sky-500 rounded-md shadow-lg shadow-indigo-500/50 dark:text-white p-4 grid-cols-1 md:grid grid-cols-3 gap-4 mb-8">
                        ...
                        <div><Image src={quotes3} className="rounded-xl shadow-lg md:-mt-8 md:ml-12" /></div>
                    </div>
                    <div className=" w-full border-2 border-sky-500 rounded-md shadow-lg shadow-indigo-500/50 dark:text-white p-4 grid-cols-1 md:grid grid-cols-3 gap-4 mb-8">
                        <div><Image src={quotes4} className="rounded-xl shadow-lg md:-mb-8 md:-ml-12" /></div>
                        <div className="col-span-2 text-center flex items-center ">
                            <div>
                    ...
                    <div className=" w-full border-2 border-sky-500 rounded-md shadow-lg shadow-indigo-500/50 dark:text-white p-4 grid-cols-1 md:grid grid-cols-3 gap-4 mb-8">
                        ...
                        <div><Image src={quotes5} className="rounded-xl shadow-lg md:-mt-8 md:ml-12" /></div>
                    </div>
                </section>
            </main>
        </div>
